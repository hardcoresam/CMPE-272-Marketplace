...
export default function Login(props) {
        ...
        axios({
            ...
            if (response.status === 200) {
                if (response.data !== '') {
                    ...
                    if (signinForm.email === 'admin@gmail.com' && signinForm.password === 'password') {
                        localStorage.setItem("adminLoggedIn", true);
    ...
    return (
        <Fragment>
            <h4 style={{ marginLeft: "15%", marginRight: "15%", marginTop: 15, textAlign: "center" }}>Please login below</h4>
                    ...
                    <Form onSubmit={(e) => loginSubmit(e)}>
                        <Card.Text>
                            <Row style={{ margin: 15 }}>
                                ...
                                <Col>
                                    <Form.Group className="mb-3">
                                        <Form.Control type="text" name="email" value={signinForm.email} onChange={(e) => handleFormDataChange(e)} autoFocus required />
                                    </Form.Group>
                                </Col>
                            </Row>
                            ...
                            <Row style={{ margin: 15 }}>
                                ...
                                <Col>
                                    <Form.Group className="mb-3">
                                        <Form.Control type="password" name="password" value={signinForm.password} onChange={(e) => handleFormDataChange(e)} required />
                                    </Form.Group>
                                </Col>
                            </Row>
                        </Card.Text>
                        <Button variant="primary" style={{ width: "100%" }} type="submit" className="rounded-pill">Login</Button>
                    </Form>
                </Card.Body>
            </Card>
        </Fragment>
